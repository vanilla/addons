...
if ($this->Badges && class_exists('BadgeModel')) {
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer.png',
        'Points' => 2,
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer-2.png',
        'Points' => 3,
        'Attributes' => ['Column' => 'CountAcceptedAnswers'],
        'Threshold' => 5,
        'Class' => 'Answerer',
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer-3.png',
        'Points' => 5,
        'Attributes' => ['Column' => 'CountAcceptedAnswers'],
        'Threshold' => 25,
        'Class' => 'Answerer',
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer-4.png',
        'Points' => 10,
        'Attributes' => ['Column' => 'CountAcceptedAnswers'],
        'Threshold' => 50,
        'Class' => 'Answerer',
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer-5.png',
        'Points' => 15,
        'Attributes' => ['Column' => 'CountAcceptedAnswers'],
        'Threshold' => 100,
        'Class' => 'Answerer',
    ...
    $BadgeModel->define([
        ...
        'Photo' => 'https://badges.v-cdn.net/100/answer-6.png',
        'Points' => 20,
        'Attributes' => ['Column' => 'CountAcceptedAnswers'],
        'Threshold' => 250,
        'Class' => 'Answerer',
