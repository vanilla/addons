...
$PluginInfo['AuthorSelecter'] = array(
   'Name' => 'Author Selecter',
...
class AuthorSelecterPlugin extends Gdn_Plugin {
   /** None. */
   ...
   public function DiscussionController_Author_Create($Sender, $Args) {
      ...
      $Sender->Render('changeauthor', '', 'plugins/AuthorSelecter');
   }
   ...
   protected function AddJsFiles($Sender) {
      ...
      $Sender->AddJsFile('authorselecter.js', 'plugins/AuthorSelecter');
   }
