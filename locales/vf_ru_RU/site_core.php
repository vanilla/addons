...
$Definition[' You should '] = 'Вы должны';
...
$Definition['%1$s signed in.'] = '%1$s вошел.';
...
$Definition['%s is required.'] = 'Необходим %s.';
...
$Definition['markallviewed'] = 'Отметить все прочитанными';
