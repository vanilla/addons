...
$Definition['About.VanillaStatistics'] = 'Il est important, pour que ce logiciel gratuit et open-source continue à évoluer, que nous puissions mesurer avec précision la portée et l\'efficacité de Vanilla. Nous vous demandons, s\'il vous plaît, de ne pas désactiver la collecte de ces données.';
...
$Definition['Add a new Pocket to your site.'] = 'Ajoutez une nouvelle Poche (formulaire HTML) à votre site.';
...
$Definition['Although the invitation was created successfully, the email failed to send. The server reported the following error: %s'] = 'Bien que l\'invitation ait bien été créée, le courriel n\'a pu être envoyé. Le serveur a renvoyé l\'erreur suivante : %s';
...
$Definition['Authors may edit for %s'] = 'Les auteurs peuvent éditer pour %s';
...
$Definition['Basic'] = 'Sélectionner le statut qui sera appliqué aux nouveaux candidats. Ceci ne vous concerne que si vous avez choisi la méthode d\'enregistrement par approbation.';
$Definition['Basic Information'] = 'Information basique';
...
$Definition['Change Log'] = 'Changer le log';
...
$Definition['ConnectCreateAccount'] = 'Ajouter information &amp; créer compte';
...
$Definition['Could not instantiate mail function.'] = 'La fonction courriel n\'a pu être concrétisée.';
...
$Definition['Define who can upload and manage files on the '] = 'Roles & Permissions\',\'/dashboard/role';
$Definition['Define who can upload and manage files on the <a href="/dashboard/role">Roles & Permissions</a> page.'] = 'Définissez qui peut télécharger et gérer les fichiers sur la page <a href="/dashboard/role">Statuts & Autorisations</a>';
...
$Definition['Delete Role'] = 'Supprimer le rôle';
...
$Definition['Deleting a role can result in users not having access to the application.'] = 'Supprimer un rôle peut mener à avoir des utilisateurs sans accès à l\'application.';
...
$Definition['Disabled: The pocket will <b>not</b> be displayed.'] = 'Désactivé: La poche <b>ne sera pas</b> affichée.';
$Definition['Discussion'] = 'Conversation';
...
$Definition['Enabled: The pocket will be displayed.'] = 'Désactivé: La poche sera affichée.';
...
$Definition['Enter a descriptive name.'] = 'Renseignez un nom descriptif pour la poche. Ce nom ne sera affiché nulle part, sauf dans cet espace de gestion des poches, il est donc utilisé uniquement pour vous aider à vous souvenir de la poche.';
...
Follow the link below to log in.'] = 'Salut l\'ami !
...
$Definition['Hide Pocket Locations'] = 'Masquer les emplacements des Poches';
...
$Definition['Limit the display of this pocket for embedded comments.'] = 'Limiter l\'affichage de cette poche pour les commentaires intégrés.';
$Definition['Limit the display of this pocket for mobile devices.'] = 'Limiter l\'affichage de cette poche pour les appareils mobiles.';
$Definition['Limit the display of this pocket to "mobile only".'] = 'Limiter l\'affichage de cette poche aux appareils mobiles uniquement.';
$Definition['Limit the pocket to one or more roles or permissions.'] = 'Limiter cette poche à un ou plusieurs statuts ou permissions.';
...
$Definition['Most pockets shouldn\'t be displayed in the dashboard.'] = 'Les poches supplémentaires ne peuvent être affichées dans le tableau de bord.';
...
$Definition['Pocket'] = 'Poche';
$Definition['Pockets'] = 'Poches';
$Definition['Pockets allow you to add free-form HTML to various places around the application.'] = 'Les Poches vous permettent d\'ajouter des formulaires HTML à divers emplacements de l\'application.';
$Definition['Pockets.BetweenDiscussions.Description'] = 'La poche est affichée entre chaque discussion sur la liste de discussion principale. Puisque les discussions sont généralement à l\'intérieur de balises &lt;li&lg;…&lt;/li&lg;, vous devrez également envelopper vos poches dans ces balises.';
...
$Definition['Select the location of the pocket.'] = 'Sélectionnez l\'emplacement de la poche';
...
$Definition['Show Pocket Locations'] = 'Voir l\'emplacement de la Poche';
$Definition['Show all possible pocket locations.'] = 'Activez cette option pour afficher tous les emplacements de poches disponibles. En activant cette option, les emplacements seront uniquement visibles par les utilisateurs qui peuvent gérer les poches.';
...
$Definition['Table Layout'] = 'Mise en page de table';
$Definition['Temporary (302)'] = 'Temporaire (302)';
$Definition['Test'] = 'Test';
$Definition['Test Mode'] = 'Mode Test : La poche ne sera affichée que pour les administrateurs de poches.';
$Definition['Test Mode: The pocket will only be displayed for pocket administrators.'] = 'Mode Test : La poche ne sera affichée que pour les administrateurs de poches.';
...
$Definition['The text of the pocket.'] = 'Entrez le texte de la poche. Il ressortira exactement comme vous le taper alors assurez-vous que vous entrez du HTML valide.';
...
$Definition['This option shows/hides the locations where pockets can go.'] = 'Cette option affiche ou masque les emplacements où des poches peuvent aller, mais seulement pour les utilisateurs qui ont la permission d\'ajouter / modifier des poches. Essayez d\'afficher les emplacements, puis visitez votre site.';
...
$Definition['You can ban IP addresses, email domains, and words from usernames using this tool.'] = 'Vous pouvez bannir des adresses IP, des domaines de courriel et des mots dans les noms d\'utilisateurs grâce à cet outil.';
