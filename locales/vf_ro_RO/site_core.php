...
$Definition['A fatal error occurred while processing the request.<br />The server returned the following response: %s'] = 'Ooops! Eroare in timpul procesarii cererii.<br />Serverul a returnat urmatorul raspuns: %s';
...
$Definition['Activity.DiscussionComment.FullHeadline'] = '%1$s a comentat pe %4$s %8$s.';
$Definition['Activity.DiscussionComment.ProfileHeadline'] = '%1$s a comentat pe %4$s %8$s.';
$Definition['Activity.DiscussionMention.FullHeadline'] = '%1$s mentionat %3$s in %8$s.';
$Definition['Activity.DiscussionMention.ProfileHeadline'] = '%1$s mentionat %3$s in %8$s.';
$Definition['Activity.Import.FullHeadline'] = '%1$s date importate.';
$Definition['Activity.Import.ProfileHeadline'] = '%1$s date importate.';
$Definition['Activity.Join.FullHeadline'] = '%1$s s-a alaturat.';
$Definition['Activity.Join.ProfileHeadline'] = '%1$s s-a alaturat.';
$Definition['Activity.JoinApproved.FullHeadline'] = '%1$s aprobat %4$s inscrierea ca utilizator.';
$Definition['Activity.JoinApproved.ProfileHeadline'] = '%1$s aprobat %4$s inscrierea ca utilizator.';
$Definition['Activity.JoinCreated.FullHeadline'] = '%3$s a creat un cont pentru %1$s.';
$Definition['Activity.JoinCreated.ProfileHeadline'] = '%3$s a creat un cont pentru %1$s.';
$Definition['Activity.JoinInvite.FullHeadline'] = '%1$s a acceptat %4$s invitatia de inscriere.';
$Definition['Activity.JoinInvite.ProfileHeadline'] = '%1$s a acceptat %4$s invitatia de inscriere..';
$Definition['Activity.NewDiscussion.FullHeadline'] = '%1$s a deschis o %8$s.';
$Definition['Activity.NewDiscussion.ProfileHeadline'] = '%1$s a deschis o %8$s.';
...
$Definition['Activity.RoleChange.FullHeadline'] = '%1$s a schimbat %4$s permisiunile.';
$Definition['Activity.RoleChange.ProfileHeadline'] = '%1$s a schimbat %4$s permisiunile.';
$Definition['Activity.SignIn.FullHeadline'] = '%1$s intrat in cont.';
...
$Definition['ValidateMinimumAge'] = 'Trebuie sa ai minim 16 ani pentru a continua.';
