...
$Definition['@Require users to confirm their email addresses (recommended)'] = 'מחייב משתמשים לאשר את כתובת הדואר האלקטרוני שלהם (מומלץ)';
...
$Definition['About.DisableStatistics'] = 'אם אתה מוכרח לבטל את שליחת הנתונים מסיבה עסקית כלשהי, אתה יכול לעשות זאת על ידי הוספת השורה הזאת לקובץ הקונפיגורציה שלך במהלך ההתקנה:
<code>$Configuration[\'Garden\'][\'Analytics\'][\'Enabled\'] = FALSE;</code>';
$Definition['About.VanillaStatistics'] = 'חשיבות חיונית לחייו של הפרוייקט החופשי והחינמי שלנו תלויה בכך שנצליח למדוד בצורה מדויקת עד כמה נפוץ ויעיל שירות Vanilla. אנו מבקשים שלא תבטל את שליחת הנתונים האלו.';
$Definition['AboutCommentEmbedding'] = 'שירות Vanilla יכול לשמש כתחליף לשירות ההערות של הבלוג שלך. למעשה, הוא יכול לשמש כדרך להוספת הערות על כל עמוד רשת באשר הוא.';
$Definition['AboutEmbedding'] = 'הטמעת השירות מאפשרת לחלק או כלל הקהילה שלך להיות חלק מתוכנות אחרות ועמודי רשת שונים.';
...
$Definition['AddonProblems'] = '<h2>Problems?</h2><p> אם משהו משתמש אם אחד התוספים, ואינך יכול להשתמש באתר, אתה יכול לנטרל את התוספים על ידי עריכת :</p>%s';
...
$Definition['Announce'] = 'הכרזה';
$Definition['Appearance'] = 'הופעה';
$Definition['Applicant'] = 'מועמד';
$Definition['Applicant Role'] = 'בחר את התפקיד למועמדים החדשים. בחירה זו תקפה רק אם בחרת בשיטת ה-<b>אישור</b>';
...
$Definition['ApplicationHelp'] = 'תוכנות מאפשרות לך להוסיף קבוצות גדולות של פונקציות לאתר שלך.
ברגע שהתוכנה הוספה לתיקיית ה-%s שלך, אתה יכול לאפשר או לנטרל אותה מכאן.';
...
$Definition['BadgeRecipientsHeading'] = 'משתמשים אשר קיבלו את הסמל לאחרונה';
$Definition['Ban'] = 'חסום';
$Definition['Ban Item'] = 'פריט';
...
$Definition['Categories are used to help organize discussions.'] = 'קטגוריות מסייעות בארגון הדיונים. גרור את הקטגוריות ממקום למקום על מנת לסדר אותן ';
$Definition['Categories are used to organize discussions.'] = '<strong>קטגוריות</strong> מאפשרות לך לארגן את הדיונים שלך.';
...
$Definition['Change tables to InnoDB'] = 'שינוי הטבלאות ב-InnoDB (עיין בעזרה)';
$Definition['Change the look of All Categories'] = 'אתה יכול לשנות את המראה של עמוד הקטגוריות <a href="%s">כאן</a>.';
...
$Definition['Check out these tutorials to get started using Vanilla'] = 'פלטפורמת הקהילה של Vanilla היא החזקה והפשוטה ביותר בעולם. היא סופר-דופר קלילה לשימוש. התחל עם הוידאו הזה והמשך עם הצעדים המפורטים מטה. תהנה!';
...
$Definition['Choose md5 if you\'re not sure what to choose.'] = 'אתה יכול לבחור custom hash algorithm לחתום את הבקשות שלך. האלגוריתם חייב להיות בשימוש גם בספריות התוכנה שלך. בחר ב-md5 אם אתה לא בטוח במה לבחור.';
...
$Definition['Confirm email addresses'] = 'הכרח משתמשים לאשר את כתובת הדוא"ל שלהם (מומלץ)';
$Definition['Connect'] = 'חבר';
$Definition['ConnectAccountExists'] = 'כבר יש לך חשבון כאן.';
$Definition['ConnectChooseName'] = 'בחר בשם לפיו תוצג באתר.';
$Definition['ConnectCreateAccount'] = 'הוסף את המידע & צור חשבון';
$Definition['ConnectExistingPassword'] = 'הכנס את הסיסמה של חשבונך הנוכחי.';
$Definition['ConnectLeaveBlank'] = 'השאר ריק אלא אם כן אתה מחבר את החשבון לחשבון קיים';
$Definition['ConnectRegisteredName'] = 'שם המשתמש שלך הוא: <strong>%s</strong>';
...
$Definition['Define who can upload and manage files on the '] = 'תפקידים & הרשאות \',\' /dashboard/role';
$Definition['Define who can upload and manage files on the <a href="/dashboard/role">Roles & Permissions</a> page.'] = 'הגדר מי יכול להעלות ולנהל קבצים בדף ה<a href="/dashboard/role">תפקידים & הרשאות</a>';
...
$Definition['Deleting forever cannot be undone.'] = 'מחיקה היא דרך טובה לשמירת הנקיון בפורום.';
...
$Definition['EditContentTimeout.Notes'] = 'אם למשתמש יש הגדרת תפקיד עם הרשאות לעריכת תוכן, ההרשאות שלו יעקפו הגבלה זו.';
...
$Definition['Enable embedding to use blog comments.'] = 'על מנת שזה יעבוד, אתה צריך לאפשר הטמעה.';
$Definition['Enable this message'] = 'אפשר הודעה זו.';
$Definition['Enable/Disable'] = 'אפשר / נטרל';
$Definition['Enabled'] = 'מאופשר: הכיס הזה יוצג.';
...
$Definition['Enter a descriptive name.'] = 'הכנס שם תיאורי לכיס. השם הזה לא יוצג בשום מקום מלבד בדף ניהול הכיסים, כך שהוא נועד אך ורק בשביל שתזכור על איזה כיס מדובר.';
$Definition['Enter a short name for the site.'] = 'הכנס שם קצר לאתר הזה. השם יוצג על כפתורי ההרשמות.';
...
$Definition['Guest roles'] = 'סמן את כל התפקידים שתקפים עבור אורחים';

$Definition['HeadlineFormat.AddUser'] = '{ActivityUserID,user} הוסיף חשבון עבור {RegardingUserID,user}.';
$Definition['HeadlineFormat.PictureChange'] = '{RegardingUserID,You} שינה את  {ActivityUserID,your} תמונת הפרופיל.';
$Definition['HeadlineFormat.RegistrationApproval'] = '{ActivityUserID,user} אישר את התוכנות עבור {RegardingUserID,user}.';
...
$Definition['Invitations can be sent from users\' profile pages.'] = 'אם תשתמש ברישום על ידי הזמנה, משתמשים יקבלו קישור שנקרא <a href="%s" class="Popup">ההזמנות שלי</a> בדפי הפרופיל שלהם.';
...
$Definition['Member roles'] = 'סמן את כל התפקידים התקפים למשתמשים חדשים / מאושרים.';
...
$Definition['Moderation Queue'] = 'תור לעריכה';
...
$Definition['NewApplicantEmail'] = 'מועמד חדש:';
...
$Definition['NotifyApplicant'] = 'תודיע לי כשמשתמשים מגישים בקשת הצטרפות.';
...
$Definition['Restoring your selection removes the items from this list.'] = 'בזמן השחזור, הפריטים יוסרו מרשימה זו ויוחזרו לתוך האתר.';
