...
$Definition['1 month after being sent'] = '1 месец след изпращането';
$Definition['1 week after being sent'] = '1 седмица след изпращането';
...
$Definition['Existing members send invitations to new members.'] = 'Съществуващи членове изпращат покани до нови членове.';

$Definition['Facebook Connect allows users to sign in using their Facebook account.'] = 'Facebook Connect позволява на потребителите да се впишат във форума с техния Фейсбук акаунт. <b>За да функционира правилно това разширение е необходимо да разполагате с валидно Фейсбук приложение.</b>';
$Definition['Facebook Settings'] = 'Facebook настройки';
$Definition['First Visit'] = 'Първо посещение';
$Definition['Forum Settings'] = 'Настройки на форума';

$Definition['Garden.Import.Description'] = 'Използвайте тази страница за да импортирате данни, които са били експортирани чрез Vanilla Exporter. За повече информация <a href="%s">вижте документацията за импорт на данни</a>.';
...
$Definition['Invitations will expire'] = 'Поканите ще имат краен срок';
$Definition['Invited by'] = 'Поканен от';
$Definition['It is a good idea to keep the maximum number of characters allowed in a comment down to a reasonable size.'] = 'Добра идея е да поддържате максималния брой на характери в коментар в прилични стойности.';

$Definition['Key Type'] = 'Key Type';
$Definition['Key Value'] = 'Key Value';

$Definition['Last Visit'] = 'Последни посетители';
$Definition['Locale Key (Folder)'] = 'Ключ на езиковия пакет (папка)';
$Definition['Locale Name'] = 'Име на езиковия пакет';
$Definition['Locales'] = 'Езикови пакети';
$Definition['Locales are in your %s folder.'] = 'Езиковите пакети позволяват да поддържате различни езици за интерфейса на форума. След като добавите езиковия пакет в %s , можете да го включвате и изключвате оттук.';
$Definition['Location'] = 'Location';

$Definition['Manage Applicants'] = 'Управление на кандидатите';
$Definition['Manage Applications'] = 'Управление на приложенията';
$Definition['Manage Categories'] = 'Управление на категориите';
$Definition['Manage Messages'] = 'Управление на съобщенията';
$Definition['Manage Plugins'] = 'Управление на разширенията';
$Definition['Manage Roles & Permissions'] = 'Управление на Ролите и Правата';
$Definition['Manage Routes'] = 'Управление на маршрутите';
$Definition['Manage Spam'] = 'Управление на SPAM';
$Definition['Manage Themes'] = 'Управление на темите';
$Definition['Manage Users'] = 'Управление н потребителите';
...
$Definition['New conversations in the last week'] = 'Нови разговори за последната седмица';
$Definition['New discussions in the last day'] = 'Нови дискусии за последния ден';
$Definition['New discussions in the last week'] = 'Нови дискусии за последната седмица';
$Definition['New messages in the last day'] = 'Нови съобщения за последния ден';
$Definition['New messages in the last week'] = 'Нови съобщения за последната седмица';
$Definition['New users are reviewed and approved by an administrator (that\'s you!).'] = 'Новите потребители се преглеждат и одобряват от администратор.';
$Definition['New users fill out a simple form and are granted access immediately.'] = 'Новите потребители попълват кратка форма и получават незабавен достъп.';
$Definition['New users in the last day'] = 'Нови потребители за последния ден';
...
$Definition['Outgoing Email'] = 'Изходящ адрес за електронна поща';
...
$Definition['SMTP Host'] = 'SMTP хост';
...
$Definition['The banner title appears on the top-left of every page. If a banner logo is uploaded, it will replace the banner title on user-facing forum pages.'] = 'Името на форума се показва горе вляво на всяка страница. Ако е качено банер изображение, то ще замести заглавието на форума на всички страници достъпни за потребители.';
$Definition['ThemeHelp'] = 'Темите позволяват бързо да промените изгледа на форума.<br />След като добавите темата във Вашата %s папка, може да ги управлявате от тук.';
...
$Definition['What\'s the Buzz?'] = 'Какво ново?';
