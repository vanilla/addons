...
$Definition['%s Connect'] = '%s Kết nối';
...
$Definition['Are you sure you want to do that?'] = 'B?n th?c s? mu?n l';
...
$Definition['Cancel'] = 'Th';
$Definition['Categories'] = 'C';
$Definition['Category'] = 'Danh m?c';
...
$Definition['Close'] = '?';
$Definition['Comments'] = 'B';
$Definition['Comments per Page'] = 'S? b';
$Definition['Configure an Authenticator'] = 'C?u h';
$Definition['Confirm'] = 'X';
$Definition['Content Flagging'] = 'G';
$Definition['Conversation Messages'] = 'C';
$Definition['Conversations'] = 'Xem h?t';
$Definition['Current Authenticator'] = 'Ch?ng th?c hi?n t?i';
$Definition['Current Theme'] = 'Giao di?n hi?n t?i';

$Definition['Dashboard'] = 'B?ng ?i?u khi?n';
$Definition['Delete'] = 'X';
$Definition['Delete Account'] = 'X';
...
$Definition['Discussions'] = 'Th?o lu?n';
...
$Definition['Exclude archived discussions from the discussions list'] = 'Th?c thi l?u tr? th?o lu?n t? danh s';
$Definition['Existing members send invitations to new members.'] = 'T?n t?i ng??i d';
...
$Definition['Heads Up! This is a special role that does not allow active sessions. For this reason, the permission options have been limited to "view" permissions.'] = 'Heads Up! ?';

$Definition['Inbox'] = 'Ph';
$Definition['Information'] = 'Th';
$Definition['Invitation'] = 'Th? m?i';
$Definition['Invitation Code'] = 'M';
$Definition['Invitations per month'] = 'S? th? m?i trong th';
$Definition['Invitations will expire'] = 'Th? m?i s? h?t hi?u l?c:';
$Definition['It is a good idea to keep the maximum number of characters allowed in a comment down to a reasonable size.'] = 'N';

$Definition['Key Type'] = 'Ki?u Key';
$Definition['Key Value'] = 'Gi';

$Definition['Last Visit'] = 'L?n ??ng nh?p g?n nh?t';
$Definition['Location'] = 'V? tr';

$Definition['Manage'] = 'Qu?n l';
$Definition['Manage Applications'] = 'Qu?n l';
$Definition['Manage Categories'] = 'Qu?n l';
$Definition['Manage Messages'] = 'Qu?n l';
$Definition['Manage Plugins'] = 'Qu?n l';
$Definition['Manage Roles & Permissions'] = 'Qu?n v? tr';
$Definition['Manage Spam'] = 'Qu?n l';
$Definition['Manage Themes'] = 'Qu?n l';
$Definition['Manage Users'] = 'Qu?n l';
$Definition['Max Comment Length'] = '?? d';
$Definition['Message'] = 'Tin nh?n';
$Definition['Messages'] = 'Tin nh?n';
...
$Definition['Name'] = 'T';
$Definition['Need More Help?'] = 'Tr? gi';
$Definition['New comments in the last week'] = 'C';
$Definition['New conversations in the last week'] = 'C';
$Definition['New discussions in the last day'] = 'C';
$Definition['New discussions in the last week'] = 'C';
$Definition['New messages in the last week'] = 'C';
$Definition['New users are reviewed and approved by an administrator (that\'s you!).'] = 'Ng??i d';
$Definition['New users fill out a simple form and are granted access immediately.'] = 'Ng??i d';
$Definition['New users in the last day'] = 'Nh?ng ng??i d';
...
$Definition['Registration'] = 'Vi?c ??ng k';
$Definition['Registration is currently closed.'] = 'Ph?n ??ng k';
$Definition['Remove'] = 'X';
...
$Definition['Settings'] = 'C?u h';
$Definition['Sign Out'] = 'Tho';
$Definition['Sink'] = '?n';
...
$Definition['View'] = 'Xem';
$Definition['Visit Site'] = 'Xem Trang ch?';
